...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://foodiecart-app-mern-backend.onrender.com/api/auth/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://foodiecart-app-mern-backend.onrender.com/api/auth/createuser", {
      // credentials: 'include',
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              ...
              <input type="password" className="form-control" value={credentials.password} onChange={onChange} name='password' placeholder='create a password' />
            </div>
